...
export function TeamSection() {
  return (
    <section
      ...
      className="py-20 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto bg-linear-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800"
    >
      {/* Section Header */}
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          Passionate experts dedicated to revolutionizing sustainable agriculture through innovation
          and dedication.
        </p>
